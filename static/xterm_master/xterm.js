...
var Buffer = (function () {
    ...
    Buffer.prototype._reflow = function (newCols) {
        if (this._cols === newCols) {
            return;
        }
    ...
    Buffer.prototype._reflowLarger = function (newCols) {
        var toRemove = BufferReflow_1.reflowLargerGetLinesToRemove(this.lines, newCols);
    ...
    Buffer.prototype._reflowSmaller = function (newCols) {
        var toInsert = [];
        var countToInsert = 0;
...
Object.defineProperty(exports, "__esModule", { value: true });
var Buffer_1 = require("./Buffer");
function reflowLargerGetLinesToRemove(lines, newCols) {
    var toRemove = [];
